...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"clients", nil);
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *clientDict = [self.clientsArray objectAtIndex:indexPath.row];
    cell.textLabel.text = [clientDict objectForKey:@"name"];
